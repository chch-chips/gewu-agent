...
- AI Framework: Spring AI stable，统一以 https://docs.spring.io/spring-ai/reference/index.html 为准
...
- Spring AI 不引用 2.0-SNAPSHOT 文档。所有 API、依赖和示例以稳定版 Reference 为准。
- 使用 Spring AI BOM 管理版本，避免手写 Spring AI 相关依赖版本。
- Spring AI 2.x 暂作为后续升级观察项，不作为当前项目文档和开发基线。

### Spring AI 稳定 API 基线

当前文档按 Spring AI 稳定版 Reference 约束，关键能力采用以下 API 思路：
...
Spring AI 稳定版支持通过 ChatClient 传入工具，让框架管理工具调用生命周期。平台内应抽象 ToolRegistry：
...
- Spring AI Stable Reference: https://docs.spring.io/spring-ai/reference/index.html
